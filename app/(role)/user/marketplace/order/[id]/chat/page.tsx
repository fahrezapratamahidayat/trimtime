...
const stockLabels: Record<
  (typeof barberMarketplaceProducts)[number]["stockStatus"],
  string
> = {
  ready: "Ready stock",
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-sm text-muted-foreground">
                    Ready bantu rekomendasi produk & pengiriman
                  </CardDescription>
                </div>
              </div>
              ...
              <ScrollArea className="h-[380px] rounded-2xl border border-border/40 bg-background/90 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
                <div className="space-y-4">
                  {conversation.map((message) => {
                    ...
                    const senderName = isUser ? "Kamu" : product.barbershop.name;
